...
<html>
    <head>
        ...
        <title>EfeSystem</title>
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-primary">
            <a class="navbar-brand" style="margin-left: 5px; border: none" href="Principal.jsp"><strong style="color:#FFFFFF">EfeSystem</strong></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavSupportedContent">
                ...
                <a class="nav-link dropdown-toggle" style="color: #ffffff" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <%--
